...
```markdown
| Model | $|\Delta| < 10^{-2}$ | $|\Delta| < 10^{-3}$ | $<\sigma_{pred}>$ | $<\sigma_{mod}>$ | 
| ----- | -------------------- | -------------------- | ----------------- | ---------------- |
| $400\,000$ | $92.40\%$ | $38.80\%$ | $6.75 \cdot 10^{-4}$ | $4.98 \cdot 10^{-5}$ | 
| boost $100\,000 + 4\times$ | $92.69\%$ | $41.73\%$ | $6.09 \cdot 10^{-4}$ | $4.03 \cdot 10^{-5}$ | 
| boost $400\,000 + 4\times$ | $95.01\%$ | $60.55\%$ | $5.52 \cdot 10^{-4}$ | $1.49 \cdot 10^{-5}$ | 
```
